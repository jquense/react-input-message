...
var Message = (function (_React$Component) {
  ...
  Message.prototype.render = function render() {
    ...
    var props = babelHelpers.objectWithoutProperties(_props, ['component', 'messages', 'active', 'delim', 'filter', 'for']);
    ...
    return React.createElement(
      Component,
      props,
      values(messages).reduce(flatten, []).filter(filter).join(delim)
    );
  };
