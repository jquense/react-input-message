...
module.exports = (function (_React$Component) {
  ...
  ValidationContainer.prototype.getChildContext = function getChildContext() {
    ...
    return this._context || (this._context = {
      ...
      register: function (name, group, target) {
        _this.addField(name, group, target);
        return _this.removeField.bind(_this, name, group);
      },
      ...
      onValidateGroup: function (group, event, target, args) {
        var isGroup = !(!group || !group.length),
            inputs = isGroup ? _this._fieldsForGroups(group) : Object.keys(_this._fields);
  ...
  ValidationContainer.prototype._fieldsForGroups = function _fieldsForGroups(grps) {
    var _this = this;
